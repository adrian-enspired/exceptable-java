...
import red.enspi.exceptable.exception.NullPointerException;

/** Indicates an attempt to access or invoke a method on a null object reference. */
public enum NullPointer implements Signal<NullPointerException> {
