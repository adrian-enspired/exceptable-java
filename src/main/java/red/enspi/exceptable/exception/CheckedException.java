...
public class CheckedException extends java.lang.Exception implements Exceptable {
  ...
  public CheckedException() {
    this(Checked.UnknownError, null, null);
  }

  public CheckedException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : Checked.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : Checked.UnknownError;
