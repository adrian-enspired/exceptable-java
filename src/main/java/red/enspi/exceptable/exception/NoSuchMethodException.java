...
/** _Exceptable_ for NoSuchMethod errors. */
public class NoSuchMethodException extends java.lang.NoSuchMethodException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public NoSuchMethodException() {
    this(NoSuchMethod.UnknownError, null, null);
  }

  public NoSuchMethodException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : NoSuchMethod.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : NoSuchMethod.UnknownError;
