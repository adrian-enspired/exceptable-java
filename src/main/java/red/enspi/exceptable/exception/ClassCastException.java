...
/** _Exceptable_ for ClassCast errors. */
public class ClassCastException extends java.lang.ClassCastException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public ClassCastException() {
    this(ClassCast.UnknownError, null, null);
  }

  public ClassCastException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : ClassCast.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : ClassCast.UnknownError;
