...
/** _Exceptable_ for NumberFormatException errors. */
public class NumberFormatException extends java.lang.NumberFormatException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public NumberFormatException(ConstructArgs args) {
    super(args.message());
