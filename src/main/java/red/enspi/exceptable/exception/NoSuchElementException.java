...
/** _Exceptable_ for NoSuchElement errors. */
public class NoSuchElementException extends java.util.NoSuchElementException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public NoSuchElementException() {
    this(NoSuchElement.UnknownError, null, null);
  }

  public NoSuchElementException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : NoSuchElement.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : NoSuchElement.UnknownError;
