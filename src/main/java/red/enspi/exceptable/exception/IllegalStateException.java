...
/** _Exceptable_ for IllegalState errors. */
public class IllegalStateException extends java.lang.IllegalStateException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public IllegalStateException() {
    this(IllegalState.UnknownError, null, null);
  }

  public IllegalStateException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : IllegalState.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : IllegalState.UnknownError;
