...
/** _Exceptable_ for Interrupted errors. */
public class InterruptedException extends java.lang.InterruptedException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public InterruptedException() {
    this(Interrupted.UnknownError, null, null);
  }

  public InterruptedException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : Interrupted.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : Interrupted.UnknownError;
