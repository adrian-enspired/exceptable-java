...
public class FileNotFoundException extends java.io.FileNotFoundException implements Exceptable {
  ...
  public FileNotFoundException() {
    this(FileNotFound.UnknownError, null, null);
  }

  public FileNotFoundException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : FileNotFound.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : FileNotFound.UnknownError;
