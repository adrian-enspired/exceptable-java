...
/** _Exceptable_ for IllegalArgument errors. */
public class IllegalArgumentException extends java.lang.IllegalArgumentException implements Exceptable {
  ...
  public IllegalArgumentException() {
    this(IllegalArgument.UnknownError, null, null);
  }

  public IllegalArgumentException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : IllegalArgument.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : IllegalArgument.UnknownError;
