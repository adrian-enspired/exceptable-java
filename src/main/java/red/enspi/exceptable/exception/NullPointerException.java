...
/** _Exceptable_ for NullPointer errors. */
public class NullPointerException extends java.lang.NullPointerException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public NullPointerException() {
    this(NullPointer.UnknownError, null, null);
  }

  public NullPointerException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : NullPointer.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : NullPointer.UnknownError;
