...
/** _Exceptable_ for IndexOutOfBounds errors. */
public class IndexOutOfBoundsException extends java.lang.IndexOutOfBoundsException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public IndexOutOfBoundsException() {
    this(IndexOutOfBounds.UnknownError, null, null);
  }

  public IndexOutOfBoundsException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : IndexOutOfBounds.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : IndexOutOfBounds.UnknownError;
