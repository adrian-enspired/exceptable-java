...
/** _Exceptable_ for UnsupportedOperation errors. */
public class UnsupportedOperationException extends java.lang.UnsupportedOperationException implements Exceptable {

  private final Signal<?> signal;
  private final Context context;

  public UnsupportedOperationException() {
    this(UnsupportedOperation.UnknownError, null, null);
  }

  public UnsupportedOperationException(Signal<?> signal, Context context, Throwable cause) {
    super(signal != null ? signal.message(context) : UnsupportedOperation.UnknownError.message(context));
    ...
    this.signal = (signal != null) ? signal : UnsupportedOperation.UnknownError;
